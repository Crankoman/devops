...
def run_module():
    ...
    try:
        ...
        module.fail_json(msg="File exist", **result)
    except IOError:
...
```commandline
(venv) root@4SER-1670916090:/tmp/ansible# python -m ansible.modules.my_own_module test.json
{"changed": true, "original_message": "", "message": "", "invocation": {"module_args": {"path": "/tmp/path.txt", "content": "test_content"}}}

(venv) root@4SER-1670916090:/tmp/ansible# cat /tmp/path.txt
test_content
...
PLAY [test task my_own_module] *********************************************************************************************************************************

TASK [Gathering Facts] *****************************************************************************************************************************************
ok: [localhost]

TASK [Create file + content] ***********************************************************************************************************************************
changed: [localhost]
...
```yaml
---
- name: test task role my_own_module
  hosts: localhost
  roles:
    role: my_own_module
